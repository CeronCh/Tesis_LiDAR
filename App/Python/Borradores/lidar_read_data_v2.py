...
#def filter_zero_distances(angles_rads, angles_degs, new_angles_rads, new_angles_degs, distances, x_coords, y_coords):
#    mask_zero = distances > 0
#    return (angles_rads[mask_zero], angles_degs[mask_zero], new_angles_rads[mask_zero],
#            new_angles_degs[mask_zero], distances[mask_zero], x_coords[mask_zero], y_coords[mask_zero])
